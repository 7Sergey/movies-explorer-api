...
const movieSchema = new mongoose.Schema(
  {
    ...
    nameEN: {
      ...
      validate: {
        validator: (value) => {
          // Добавьте свою логику валидации для nameEN
          // Например, проверка на допустимые символы или длину
          return /^[a-zA-Z\s-]+$/i.test(value) // Пример: только английские буквы, пробелы и дефисы
        },
        message: (props) =>
